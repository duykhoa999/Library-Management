...
<head>
    ...
    <!-- Mobile Menu -->
    <link href="resources/css/mmenu.css" rel="stylesheet" type="text/css" />
    <link href="resources/css/mmenu.positioning.css" rel="stylesheet" type="text/css" />
                                ...
                                <div class="navbar-brand">
                                    <h1>
                                        <a href="home/index.htm">
                                            <img src="resources/images/libraria-logo-v1.png" alt="LIBRARIA" />
                                        </a>
                                    </h1>
                                </div>
                            </div>
                                        ...
                                        <div class="topbar-links">
                                        	<c:choose>
											  <c:when test="${mUser == null}">
											   	<a href="login.htm"><i class="fa fa-lock"></i>Login / Register</a>
											  </c:when>
											  <c:otherwise>
												<div class="dropdown">
	                                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
	                                                    <i class="fa fa-lock"></i>Hello, ${mUser.staff.name}
	                                                </a>
	                                                <div class="dropdown-menu cart-dropdown">
	                                                    <ul>
	                                                        <c:if test="${mUser.staff.role == 'Admin' }">
	                                                        	<li class="clearfix">
		                                                        	<div class="item-info">
		                                                                <div class="name">
		                                                                    <a href = "admin/index.htm">Admin Page</a>
		                                                                </div>
		                                                            </div>
		                                                        </li>
	                                                        </c:if>
	                                                        <li class="clearfix">
	                                                        	<div class="item-info">
	                                                                <div class="name">
	                                                                    <a href = "change-password.htm">Change Password</a>
	                                                                </div>
	                                                            </div>
	                                                        </li>
	                                                        <li class="clearfix">
                                            ...
                                            <!-- <div class="header-cart dropdown">
                                                ...
                                                <div class="dropdown-menu cart-dropdown">
                                                    <ul>
                                                        <li class="clearfix">
                                                            <img src="resources/images/header-cart-image-01.jpg" alt="cart item" />
                                                            <div class="item-info">
                                                                <div class="name">
                                                        ...
                                                        <li class="clearfix">
                                                            <img src="resources/images/header-cart-image-02.jpg" alt="cart item" />
                                                            <div class="item-info">
                                                                <div class="name">
                                                                    <a href="#">The Great Gatsby</a>
                                                                </div>
                                                        ...
                                                        <li class="clearfix">
                                                            <img src="resources/images/header-cart-image-03.jpg" alt="cart item" />
                                                            <div class="item-info">
                                                                <div class="name">
                                                                    <a href="#">The Great Gatsby</a>
                                                                </div>
                            ...
                            <div class="navbar-collapse hidden-sm hidden-xs">
                                <ul class="nav navbar-nav">
                                    <li class="dropdown active">
                                        <a data-toggle="dropdown" class="dropdown-toggle disabled" href="home/index.htm">Home</a>
                                    ...
                                    <li class="dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle disabled" href="book.htm">Books</a>
                                        <!-- <ul class="dropdown-menu">
    ...
    <div data-ride="carousel" class="carousel slide" id="home-v1-header-carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <figure>
                    <img alt="Home Slide" src="resources/images/header-slider/home-v1/header-slide.jpg" />
                </figure>
                <div class="container">
        ...
        <div id="category-filter">
            <ul class="category-list">
                <li class="category-item adults">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-01.jpg" alt="New Releaase" />
                ...
                <li class="category-item kids-teens">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-02.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <li class="category-item video">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-03.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <li class="category-item audio">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-04.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <li class="category-item books">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-05.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <li class="category-item magazines">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-06.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <li class="category-item adults">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-07.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <li class="category-item kids-teens">
                    <figure>
                        <img src="resources/images/category-filter/home-v1/category-filter-img-08.jpg" alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                                <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
        ...
        <div class="container">
            ...
            <div class="team-list">
                <div class="team-member">
                    <figure>
                        <img src="resources/images/team-img-01.jpg" alt="team" />
                    </figure>
                ...
                <div class="team-member">
                    <figure>
                        <img src="resources/images/team-img-02.jpg" alt="team" />
                    </figure>
                    <div class="content-block">
                        <div class="member-info">
                ...
                <div class="team-member">
                    <figure>
                        <img src="resources/images/team-img-03.jpg" alt="team" />
                    </figure>
                    <div class="content-block">
                        <div class="member-info">
                            <h4>Anna Delpan</h4>
            ...
            <div class="tabs-container">
                ...
                <div class="tabs-list">
                    <div class="tab-content active">
                        <article>
                            <figure>
                                <img src="resources/images/latest-blog-img-home-v1.jpg" alt="Latest Blog">
                                <figcaption>
                                    <a href="#.">
                    ...
                    <div class="tab-content">
                        <article>
                            <figure>
                                <img src="resources/images/latest-blog-img-home-v1-2.jpg" alt="Latest Blog">
                                <figcaption>
                                    <a href="#.">
            ...
            <div class="owl-carousel">
                <div class="single-testimonial-box">
                    <div class="top-portion">
                        <img src="resources/images/testimonial-image-01.jpg" alt="Testimonial Image" />
                ...
                <div class="single-testimonial-box">
                    <div class="top-portion">
                        <img src="resources/images/testimonial-image-02.jpg" alt="Testimonial Image" />
                        <div class="user-comment">
                            <div class="arrow-left"></div>
                            <blockquote cite="#">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna magna, rhoncus eget commodo et, dignissim non nulla. Sed sit amet vestibulum ex. Donec dolor velit
        ...
        <div class="container">
            ...
            <div class="news-events-list">
                <div class="single-news-event">
                    <figure>
                        <img src="resources/images/news-event/news-event-01.jpg" alt="News & Event" />
                    </figure>
                    <div class="content-block">
                        <div class="member-info">
                ...
                <div class="single-news-event">
                    <figure>
                        <img src="resources/images/news-event/news-event-02.jpg" alt="News & Event" />
                    </figure>
                    <div class="content-block">
                        <div class="member-info">
                            <div class="content_meta_category">
                ...
                <div class="single-news-event">
                    <figure>
                        <img src="resources/images/news-event/news-event-03.jpg" alt="News & Event" />
                    </figure>
                    <div class="content-block">
                        <div class="member-info">
                            <div class="content_meta_category">
...
<!-- Start: Footer -->
    ...
    <!-- Mobile Menu -->
    <script type="text/javascript" src="resources/js/mmenu.min.js"></script>
    
    <!-- Harvey - State manager for media queries -->
    <script type="text/javascript" src="resources/js/harvey.min.js"></script>
    
    <!-- Waypoints - Load Elements on View -->
    <script type="text/javascript" src="resources/js/waypoints.min.js"></script>

    <!-- Facts Counter -->
    <script type="text/javascript" src="resources/js/facts.counter.min.js"></script>
    ...
    <!-- Responsive Tabs -->
    <script type="text/javascript" src="resources/js/responsive.tabs.min.js"></script>
    
    <!-- Responsive Table -->
    <script type="text/javascript" src="resources/js/responsive.table.min.js"></script>
    
    <!-- Masonry -->
    <script type="text/javascript" src="resources/js/masonry.min.js"></script>
    
    <!-- Carousel Swipe -->
    <script type="text/javascript" src="resources/js/carousel.swipe.min.js"></script>
