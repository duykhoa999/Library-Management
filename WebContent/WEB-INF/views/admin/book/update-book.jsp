	           ...
	           <div class="col-md-12">
	               ...
	               <div class="card">
	                   <div class="card-body">
	                       ...
	                       <form:form action="admin/book/update-book/${book.id }.htm" method="POST" modelAttribute = "book" enctype = "multipart/form-data">
	                           ...
	                           <div class="form-group">
	                               	...
	                               	<form:input type="text" path = "year" class="form-control" placeholder="Năm xuất bản"/>
	                           ...
	                           <button type="submit" class="btn btn-success">Chỉnh sửa sách</button>
	                       </form:form>
	                   </div>
	               </div>
	           </div>
