                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="company-detail bg-dark margin-left">
                                                    ...
                                                    <form:form class="login" action ="login.htm" method="post" modelAttribute="user">
                                                       <p class="form-row form-row-first input-required">
                                                           <!--  <label>
                                                            ...
                                                            <form:input path="username" type = "text" name="username" class="input-text" placeholder="Username"/>
                                                        ...
                                                        <p class="form-row form-row-last input-required">
                                                        	...
                                                        	<form:input path="password" type ="password" name="password" class="input-text" placeholder="Password"/>
                                                        ...
                                                        <div class="password-form-row">
                                                            ...
                                                            <p class="lost_password">
                                                                <a href="forgot-password.htm">Lost your Pin?</a>
                                                            </p>
                                                        </div>
