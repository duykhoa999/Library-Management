	               ...
	               <div class="card">
	                   <div class="card-body">
		                   <div class = "card-tittle">
		                   		<h3 style = "text-align: center;">ADD NEW READER</h3>
		                   		<br>
		                   </div>
	                       ...
	                       <form:form action="service/card/add-card.htm" method="POST" modelAttribute="reader">
	                           <div class="form-group pt-5">
	                               	<label for="id">ID</label>
	                               	<form:input path ="id" type="text" class="form-control" placeholder="Reader ID / Card ID"/>
	                           		<form:errors path = "id"/>
	                           </div>
